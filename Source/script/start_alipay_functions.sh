...
log_md_set_cron_clear() {
  ...
  logd "┃内容解读 | $print_set"
  logd "┃杀死上次定时 | pid: $start_alipay_crond_pid_1"
  logd "┃定时启动成功 | pid: $start_alipay_crond_pid_2"
  logd "┗━━━━━━━━━━━━━━━━━━━━━━━━━━━━━"
  logd " "
}
...
chmod -R 0777 "$start_alipay_list_path"
if [[ ! -d "$start_alipay_list_path" ]]; then
  echo "- 模块Android目录不存在！"
  exit 88
fi
...
#配置log文件路径
log="$start_alipay_list_path/log.md"
#检测屏幕状态
