...
GITEE_URL="https://gitee.com/lucky__cat/magisk-modules/raw/Battery_whitelist/update.json"
GITHUB_URL="https://raw.githubusercontent.com/lucky-cry/magisk-modules/Battery_whitelist/update.json"

# 切换 updateJson 的函数
switch_update_json() {
    MODULE_PROP="/data/adb/modules/Battery_whitelist/module.prop"
